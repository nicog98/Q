//
//  AppleMusicAuthorizationController.swift
//  Q
//
...
class AppleMusicAuthorizationController {
    ...
    init(appleMusicController: AppleMusicController) {
        ...
        if SKCloudServiceController.authorizationStatus() == .authorized {
            ...
            if let token = UserDefaults.standard.string(forKey: AppleMusicAuthorizationController.userTokenUserDefaultsKey) {
                userToken = token
            } else {
    ...
    func requestCloudServiceAuthorization() {
        ...
        SKCloudServiceController.requestAuthorization { [weak self] (authorizationStatus) in
            ...
            NotificationCenter.default.post(name: AppleMusicAuthorizationController.authorizationDidUpdateNotification, object: nil)
        }
    }
    ...
    func requestMediaLibraryAuthorization() {
        ...
        MPMediaLibrary.requestAuthorization { (_) in
            NotificationCenter.default.post(name: AppleMusicAuthorizationController.cloudServiceDidUpdateNotification, object: nil)
        }
    }
    ...
    func requestUserToken() {
        guard let developerToken = appleMusicController.fetchDeveloperToken() else {
            return
        }
        ...
        if SKCloudServiceController.authorizationStatus() == .authorized {
            ...
            let completionHandler: (String?, Error?) -> Void = { [weak self] (token, error) in
                ...
                userDefaults.set(token, forKey: AppleMusicAuthorizationController.userTokenUserDefaultsKey)
